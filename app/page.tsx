...
function Header() {
  return (
    <header className="sticky top-0 z-40 border-b border-white/12 bg-[rgba(38,56,91,0.88)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        <a href="#" className="min-w-0">
          <p className="truncate font-serif text-lg font-semibold leading-none text-white">Daniela López</p>
          <p className="mt-1 text-xs font-medium text-white/68">Psicóloga General Sanitaria · Madrid</p>
        </a>
        ...
        <a
          ...
          className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-bold text-[#26385B] shadow-[0_8px_20px_rgba(38,56,91,0.12)] transition hover:bg-white/90"
        >
...
function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_12%_18%,_rgba(184,202,130,0.28),_transparent_25%),radial-gradient(circle_at_82%_12%,_rgba(140,137,184,0.28),_transparent_24%),linear-gradient(135deg,_#26385B_0%,_#6F6D9E_52%,_#B8CA82_100%)] text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 pb-14 pt-8 sm:px-6 lg:px-8 lg:pb-24 lg:pt-16">
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="order-2 lg:order-1">
            {/* Trust Badge */}
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/12 px-4 py-2 text-sm font-semibold text-white shadow-[0_8px_20px_rgba(38,56,91,0.12)] backdrop-blur">
              <CheckCircle2 className="h-4 w-4" />
              Psicóloga General Sanitaria en Madrid · Colegiada M-41829
            </div>

            {/* Headline */}
            <h1 className="mb-5 max-w-3xl font-serif text-4xl font-semibold leading-[1.04] text-white sm:text-5xl lg:text-6xl text-balance">
              Daniela López | Psicóloga en Madrid especializada en ansiedad e infancia
            </h1>

            {/* Subheadline */}
            <p className="mb-7 max-w-2xl text-lg leading-relaxed text-white/86 sm:text-xl text-pretty">
            ...
            <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-6 py-4 text-base font-bold text-[#26385B] shadow-[0_18px_40px_rgba(0,0,0,0.22)] transition-all hover:-translate-y-0.5 hover:bg-white/92 active:scale-[0.98]"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/38 bg-white/10 px-6 py-4 text-base font-semibold text-white shadow-[0_8px_20px_rgba(38,56,91,0.12)] backdrop-blur transition-all hover:-translate-y-0.5 hover:bg-white/18 active:scale-[0.98]"
              >
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <span
                  key={badge}
                  className="rounded-full border border-white/60 bg-white/90 px-3 py-2 text-sm font-semibold text-[#384461] shadow-[0_8px_20px_rgba(38,56,91,0.12)] backdrop-blur"
                >
                  {badge}
                </span>
              ))}
          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              {/* Main Image */}
              <div className="relative overflow-hidden rounded-[28px] border border-white/30 shadow-[0_26px_72px_rgba(38,56,91,0.26)]">
                <img
              ...
              {/* Floating Price Card */}
              <div className="absolute -bottom-4 -left-4 rounded-2xl border border-white/70 bg-white/95 p-4 shadow-[0_26px_72px_rgba(38,56,91,0.26)] backdrop-blur sm:-bottom-6 sm:-left-6 sm:p-5">
...
function EmpathySection() {
  ...
  return (
    <section className="bg-[radial-gradient(circle_at_top_left,_rgba(184,202,130,0.20),_transparent_24%),radial-gradient(circle_at_85%_18%,_rgba(140,137,184,0.16),_transparent_24%),linear-gradient(135deg,_#f8f8f5_0%,_#f4f5ee_55%,_#e8ecd9_100%)] py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {problems.map((problem) => (
            <div
              key={problem.title}
              className="rounded-2xl border border-[#E2E4D8] bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(250,250,247,0.92)_100%)] shadow-[0_14px_34px_rgba(38,56,91,0.08)] transition-all hover:-translate-y-0.5 hover:border-[#8C89B8]/35 hover:shadow-[0_24px_60px_rgba(38,56,91,0.13)] p-6"
            >
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#8C89B8]/12">
                <problem.icon className="h-6 w-6 text-[#6F6D9E]" />
              </div>
...
function PersonalTrustSection() {
  return (
    <section className="bg-[radial-gradient(circle_at_top_left,_rgba(184,202,130,0.18),_transparent_28%),radial-gradient(circle_at_85%_18%,_rgba(140,137,184,0.14),_transparent_24%),linear-gradient(180deg,_#fbfbf8_0%,_#f3f4ed_100%)] py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          {/* Image Column */}
          <div className="relative">
            <div className="overflow-hidden rounded-[28px] border border-white/70 shadow-[0_24px_60px_rgba(38,56,91,0.12)]">
              <img
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div key={feature} className="flex items-center gap-3">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#8C89B8]">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            {/* Address Card */}
            <div className="mb-6 rounded-2xl border border-[#E2E4D8] bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(250,250,247,0.92)_100%)] shadow-[0_14px_34px_rgba(38,56,91,0.08)] p-6">
              <div className="flex items-start gap-4">
                <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-[#B8CA82]/18">
                  <MapPin className="h-6 w-6 text-[#7F9256]" />
                </div>
                <div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {modalities.map((modality) => (
            <div
              key={modality.title}
              className="rounded-2xl border border-[#E2E4D8] bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(250,250,247,0.92)_100%)] shadow-[0_14px_34px_rgba(38,56,91,0.08)] transition-all hover:-translate-y-0.5 hover:border-[#8C89B8]/35 hover:shadow-[0_24px_60px_rgba(38,56,91,0.13)] p-8"
            >
              <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-[#8C89B8]/12">
                <modality.icon className="h-7 w-7 text-[#6F6D9E]" />
              </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {specialties.map((specialty) => (
            <div
              key={specialty.title}
              className="group rounded-2xl border border-[#E2E4D8] bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(250,250,247,0.92)_100%)] shadow-[0_14px_34px_rgba(38,56,91,0.08)] transition-all hover:-translate-y-0.5 hover:border-[#8C89B8]/35 hover:shadow-[0_24px_60px_rgba(38,56,91,0.13)] p-6"
            >
...
function PricingSection() {
  ...
  return (
    <section id="reserva" className="bg-[radial-gradient(circle_at_top_left,_rgba(184,202,130,0.18),_transparent_28%),radial-gradient(circle_at_85%_18%,_rgba(140,137,184,0.14),_transparent_24%),linear-gradient(180deg,_#fbfbf8_0%,_#f3f4ed_100%)] py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-12 max-w-3xl text-center">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {prices.map((price) => (
            <div
              key={price.title}
              className={`relative overflow-hidden rounded-2xl p-8 transition-all hover:-translate-y-0.5 ${
                price.highlighted
                  ? "bg-[linear-gradient(160deg,rgba(38,56,91,0.96)_0%,rgba(111,109,158,0.88)_56%,rgba(127,146,86,0.86)_100%)] text-white shadow-[0_26px_72px_rgba(38,56,91,0.26)]"
                  : "border border-[#E2E4D8] bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(250,250,247,0.92)_100%)] shadow-[0_14px_34px_rgba(38,56,91,0.08)] hover:shadow-[0_24px_60px_rgba(38,56,91,0.12)]"
              }`}
            >
              {price.highlighted && (
              ...
              <p className={`mb-4 text-4xl font-bold ${price.highlighted ? "text-white" : "text-[#6F6D9E]"}`}>
                {price.price}
              </p>
              <p className={`mb-6 leading-relaxed ${price.highlighted ? "text-white/90" : "text-[#5D6680]"}`}>
                {price.description}
              </p>
              <p className={`text-sm font-medium ${price.highlighted ? "text-white/80" : "text-[#5D6680]"}`}>
                {price.footer}
              </p>
            </div>
          ))}
        ...
        <div className="mt-12 text-center">
          <a
            href="https://wa.me/34614412183?text=Hola%20Daniela%2C%20he%20visto%20tu%20p%C3%A1gina%20y%20quer%C3%ADa%20pedir%20informaci%C3%B3n%20sobre%20una%20primera%20sesi%C3%B3n."
            data-event="click_whatsapp_daniela_landing"
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-8 py-4 text-lg font-bold text-white shadow-[0_18px_38px_rgba(37,211,102,0.26)] transition-all hover:-translate-y-0.5 hover:bg-[#20BD5A] hover:shadow-[0_22px_48px_rgba(37,211,102,0.32)]"
          >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {reviews.map((review, index) => (
            <div key={index} className="rounded-2xl border border-[#E2E4D8] bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(250,250,247,0.92)_100%)] shadow-[0_14px_34px_rgba(38,56,91,0.08)] p-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#B8CA82]/16 font-semibold text-[#5D6680]">
                    {review.initials}
                  </div>
        ...
        <div className="mt-8 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 font-medium text-[#6F6D9E] hover:underline"
          >
  ...
  return (
    <section className="bg-[radial-gradient(circle_at_top_left,_rgba(184,202,130,0.18),_transparent_28%),radial-gradient(circle_at_85%_18%,_rgba(140,137,184,0.14),_transparent_24%),linear-gradient(180deg,_#fbfbf8_0%,_#f3f4ed_100%)] py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="overflow-hidden rounded-[24px] border border-white/70 shadow-[0_16px_36px_rgba(38,56,91,0.14)] sm:col-span-2 lg:col-span-1 lg:row-span-2">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-3GFlcl862ZrMZVDNkE5Dstf3AjlC4A.png"
              alt="Daniela López Meléndez, psicóloga en Madrid"
          ...
          <div className="overflow-hidden rounded-[24px] border border-white/70 shadow-[0_16px_36px_rgba(38,56,91,0.14)]">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image.png-l04WYjzKlSlAEyW5zrUmhCGZyFb9UR.jpeg"
              alt="Consulta de psicología en Chamartín, Madrid"
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {steps.map((step) => (
              <div key={step.number} className="flex items-start gap-4">
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-[#8C89B8] font-bold text-white">
                  {step.number}
                </div>
...
function FAQSection() {
  ...
  return (
    <section id="faq" className="bg-[radial-gradient(circle_at_top_left,_rgba(184,202,130,0.18),_transparent_28%),radial-gradient(circle_at_85%_18%,_rgba(140,137,184,0.14),_transparent_24%),linear-gradient(180deg,_#fbfbf8_0%,_#f3f4ed_100%)] py-16 lg:py-24">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-3">
          {faqs.map((faq, index) => (
            <div key={index} className="overflow-hidden rounded-2xl border border-[#E2E4D8] bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(250,250,247,0.92)_100%)] shadow-[0_14px_34px_rgba(38,56,91,0.08)]">
              <button
              ...
              {openIndex === index && (
                <div className="border-t border-[#E2E4D8] px-5 pb-5 pt-3">
...
function FinalCTASection() {
  return (
    <section className="bg-[radial-gradient(circle_at_12%_18%,_rgba(184,202,130,0.28),_transparent_25%),radial-gradient(circle_at_82%_12%,_rgba(140,137,184,0.28),_transparent_24%),linear-gradient(135deg,_#26385B_0%,_#6F6D9E_52%,_#B8CA82_100%)] py-16 lg:py-24">
      <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col justify-center gap-4 sm:flex-row">
          <a
            href="https://wa.me/34614412183?text=Hola%20Daniela%2C%20he%20visto%20tu%20p%C3%A1gina%20y%20quer%C3%ADa%20pedir%20informaci%C3%B3n%20sobre%20una%20primera%20sesi%C3%B3n."
            data-event="click_whatsapp_daniela_landing"
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-8 py-4 text-lg font-semibold text-[#6F6D9E] shadow-lg transition-all hover:bg-white/90 hover:shadow-xl"
          >
            <MessageCircle className="h-6 w-6" />
            Hablar por WhatsApp
          </a>
...
function Footer() {
  return (
    <footer id="contacto" className="bg-[#1B2947] py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-[#E2E4D8] bg-white/95 p-3 shadow-[0_-10px_30px_rgba(10,77,104,0.16)] backdrop-blur sm:hidden">
      <div className="flex gap-2">
        ...
        <a
          href="#reserva"
          data-event="click_reserva_daniela_landing"
          className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-[#26385B] to-[#8C89B8] shadow-[0_16px_34px_rgba(38,56,91,0.20)] py-3 font-semibold text-white"
        >
          <Calendar className="h-5 w-5" />
          Reservar
        </a>
